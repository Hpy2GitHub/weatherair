...
export default function App() {
  const { phase, weather, location, coords, setCoords, error } = useWeatherData();
  ...
  return (
      <VisibilityProvider>
        <div className="app">
          ...
          {/* Rain Probability */}
{/*
          <ConditionalRenderer componentId="precipitation">
            <HourlyPrecipitation hourly={weather?.hourly} />
          </ConditionalRenderer>
*/}
